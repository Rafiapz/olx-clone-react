...
function CreatePost() {
   ...
   const handleSubmit = async () => {
      ...
      try {
         ...
         setForm({ title: "", description: "", price: "", state: "", city: "" });
               ...
               <form action="">
                  ...
                  <div className="form-items border-b px-6 py-4 flex flex-col gap-4">
                     ...
                     <div className="form-item flex flex-col gap-2">
                        ...
                        <select name="state" className="border-2 px-4 py-2 w-1/2 text-sm font-normal" value={form.state} onChange={handleChangeForm}>
                     ...
                     <div className="form-item flex flex-col gap-2">
                        ...
                        <select name="city" className="border-2 px-4 py-2 w-1/2 text-sm font-normal" value={form.city} onChange={handleChangeForm}>
                  ...
                  <div className="form-items border-b px-6 py-4 flex flex-col gap-4">
                     <button type="button" onClick={handleSubmit} className="w-max px-6 py-2 bg-emerald-900 rounded text-base font-medium text-white">
                        Post
                     </button>
                  </div>
               </form>
